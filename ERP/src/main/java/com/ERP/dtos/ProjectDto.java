...
//    @JsonIgnore
    ...
    @Size(min=3,max = 50,message = "min characters are 3 and maximum characters can be upto 20")
    @Pattern(regexp = "^[^\\s].*$", message = "Name of project must atleast one character")
    private String name;
    @NotNull(message = "Description cannot be empty")
    @Size(min=3,max = 50,message = "min characters are 3 and maximum characters can be upto 100")
