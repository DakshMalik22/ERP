...
import com.ERP.entitiesTest.ExceptionMessage;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ExceptionMessage> salaryStructureNotFoundException(SalaryStructureNotFoundException exception,
                                                                             WebRequest request){
