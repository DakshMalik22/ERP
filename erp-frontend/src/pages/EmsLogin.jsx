      ...
      <div className="flex bg-white dark:bg-[#02042B] rounded-lg shadow-lg border overflow-hidden max-w-sm lg:max-w-4xl w-full">
        ...
        <div className="w-full p-8 lg:w-1/2">
          ...
          <div className="mt-4">
            ...
            />
            { 
               emailError && <p className="text-xs text-red-600">Enter your email address*</p>
            }
          </div>
          <div className="mt-4 flex flex-col justify-between">
            ...
            <div className="input-field relative">
              ...
              />
                { 
               passwordError && <p className="text-xs text-red-600">Enter your password*</p>
              }
          ...
          <div className="mt-8">
            <button onClick={role === 'Admin' ? handleLogin : AdminLogin} className="bg-blue-700 text-white font-bold py-2 px-4 w-full rounded hover:bg-blue-600">
              Login
            </button>
          </div>
          <a
